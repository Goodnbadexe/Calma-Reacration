...
export declare function damp(a: number, b: number, lambda: number, deltaTime: number): number;
export declare function symmetricMod(value: number, base: number): number;

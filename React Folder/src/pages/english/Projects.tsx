...
const projects: Project[] = [
  ...
  { id: 1, name: "Calma Residences", description: "Luxury family homes with premium finishes and community amenities", location: "Riyadh North", price: "$2.8M", image: "/src/assets/Backgrounds/About-Header-p-1600.jpg" },
  { id: 2, name: "Heritage Villas", description: "Traditional Saudi architecture meets modern luxury living", location: "Jeddah Historic District", price: "$3.2M", image: "/src/assets/Images/About/About-Header.jpg" },
  { id: 3, name: "Garden Estates", description: "Spacious family compounds with private gardens and pools", location: "Riyadh Central", price: "$4.1M", image: "/src/assets/Backgrounds/CTA-BG-p-1600.jpg" },
  { id: 4, name: "Modern Townhomes", description: "Contemporary design with smart home technology integration", location: "New Riyadh", price: "$1.9M", image: "/src/assets/Backgrounds/Abou-1-p-1600.jpg" },
  { id: 5, name: "Executive Residences", description: "Premium homes designed for discerning professionals", location: "Diplomatic Quarter", price: "$5.2M", image: "/src/assets/Images/About/Brand-Values-1.JPG" },
  
  // Commercial Projects
  { id: 6, name: "Business Hub Central", description: "Grade A office spaces with cutting-edge infrastructure", location: "King Fahd Road", price: "$12.5M", image: "/src/assets/Backgrounds/About-Header-p-1600.jpg" },
  { id: 7, name: "Innovation Center", description: "Tech-focused commercial complex with flexible workspaces", location: "KAUST Area", price: "$8.7M", image: "/src/assets/Images/About/Stats-77097-sqm.JPG" },
  { id: 8, name: "Retail Plaza", description: "Premium shopping and dining destination", location: "Tahlia Street", price: "$15.3M", image: "/src/assets/Backgrounds/CTA-BG-p-1600.jpg" },
  { id: 9, name: "Corporate Towers", description: "Twin towers offering prestigious business addresses", location: "Financial District", price: "$25.8M", image: "/src/assets/Images/About/Stats130000-sqm.JPG" },
  { id: 10, name: "Mixed-Use Complex", description: "Integrated commercial and residential development", location: "Downtown Jeddah", price: "$18.9M", image: "/src/assets/Backgrounds/Abou-1-p-1600.jpg" },
  
  // Luxury Projects
  { id: 11, name: "Calma Tower", description: "Iconic residential tower defining the skyline", location: "King Abdullah Financial District", price: "$45.2M", image: "/src/assets/Backgrounds/About-Header-p-1600.jpg" },
  { id: 12, name: "Penthouse Collection", description: "Ultra-luxury penthouses with panoramic city views", location: "Riyadh Sky", price: "$8.5M", image: "/src/assets/Images/About/About-Header.jpg" },
  { id: 13, name: "Waterfront Residences", description: "Exclusive beachfront properties with private access", location: "Red Sea Coast", price: "$6.8M", image: "/src/assets/Backgrounds/CTA-BG-p-1600.jpg" },
  { id: 14, name: "Desert Retreat", description: "Luxury resort-style living in natural surroundings", location: "Edge of Riyadh", price: "$3.9M", image: "/src/assets/Backgrounds/Abou-1-p-1600.jpg" },
  { id: 15, name: "Sky Villas", description: "Elevated luxury living with private elevators", location: "Olaya District", price: "$7.2M", image: "/src/assets/Images/About/Brand-Values-1.JPG" },
  
  // Community Projects
  { id: 16, name: "Family Community", description: "Integrated neighborhood with schools and parks", location: "Al Nakheel", price: "$2.1M", image: "/src/assets/Images/About/Stats-77097-sqm.JPG" },
  { id: 17, name: "Senior Living", description: "Comfortable and accessible homes for mature residents", location: "Al Malqa", price: "$1.8M", image: "/src/assets/Images/About/Stats130000-sqm.JPG" },
  { id: 18, name: "Student Housing", description: "Modern accommodations near major universities", location: "University District", price: "$950K", image: "/src/assets/Backgrounds/About-Header-p-1600.jpg" },
  { id: 19, name: "Wellness Village", description: "Health-focused community with fitness facilities", location: "Green Riyadh", price: "$2.7M", image: "/src/assets/Images/About/About-Header.jpg" },
  { id: 20, name: "Cultural Quarter", description: "Arts and culture-focused residential development", location: "Historic Jeddah", price: "$3.4M", image: "/src/assets/Backgrounds/CTA-BG-p-1600.jpg" },
  
  // Sustainable Projects
  { id: 21, name: "Green Homes", description: "Eco-friendly residences with solar power integration", location: "NEOM Vicinity", price: "$4.6M", image: "/src/assets/Backgrounds/Abou-1-p-1600.jpg" },
  { id: 22, name: "Smart City Phase 1", description: "Technology-integrated sustainable community", location: "Future City", price: "$3.8M", image: "/src/assets/Images/About/Brand-Values-1.JPG" },
  { id: 23, name: "Carbon Neutral Complex", description: "Net-zero energy commercial development", location: "Green Business District", price: "$22.1M", image: "/src/assets/Images/About/Stats-77097-sqm.JPG" },
  { id: 24, name: "Renewable Energy Hub", description: "Self-sustaining mixed-use development", location: "Solar Valley", price: "$16.7M", image: "/src/assets/Images/About/Stats130000-sqm.JPG" },
  { id: 25, name: "Water Conservation Village", description: "Innovative water management residential project", location: "Desert Edge", price: "$2.9M", image: "/src/assets/Backgrounds/About-Header-p-1600.jpg" },
...
export default function RealEstateShowcase() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[800vh]" style={{ backgroundColor: "#d4cfbc" }}>
      <div className="fixed inset-0 flex items-center justify-center overflow-hidden">
        {/* Background gradient effect */}
        <div
          className="absolute inset-0 opacity-30"
          style={{
            background: `radial-gradient(circle at 50% 50%, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 70%)`,
          }}
        />
        ...
        <div className="hidden md:block absolute right-8 top-1/2 -translate-y-1/2 z-50 w-[300px]" style={{ pointerEvents: 'auto' }}>
          ...
          <input
            ...
            className="w-full bg-[#ece8e0] text-[#081e1f] placeholder:text-[#081e1f] placeholder:opacity-70 border border-[#081e1f] rounded-full px-5 py-3 shadow-md focus:outline-none focus:ring-2 focus:ring-[#081e1f] hover:bg-[#ffffff] transition-colors"
          />
        </div>
